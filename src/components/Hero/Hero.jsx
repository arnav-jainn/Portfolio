...
const Hero = () => {
  ...
  return (
    <div className="hero mb-28 flex flex-col items-center gap-9 h-screen" id="home">
      ...
      <div className="hero-action mb-12 flex items-center gap-7 text-2xl font-medium">
        ...
        <div onClick={handleResumeClick} className="hero-resume border-#fff cursor-pointer rounded-[50px] border px-16 py-5 hover:border-purple-800">
          My Resume
        </div>
      </div>
    </div>
